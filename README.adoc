...
{proj} is an extensible bot for http://polkadot.network[Polkadot], running on http://matrix.org[Matrix.org]
...
Start your substrate node:
	...
	docker run --rm -it -p 9944:9944 chevdor/substrate substrate --dev
