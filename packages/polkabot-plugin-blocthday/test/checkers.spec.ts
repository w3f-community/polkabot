...
describe('Checkers', () => {
  const casesExp = [new BN(1e1), new BN(1e2), new BN(1e3), new BN(1e14), new BN(8e5)];
  const casesExpFalse = [new BN(5), new BN(10004)];
  const casesSeq = [new BN('12'), new BN('123456')];
  const casesSeqFalse = [new BN('1237'), new BN('1234576'), new BN('12345678910')];
  ...
  const cases11thFalse = [new BN('5'), new BN('11211')];
